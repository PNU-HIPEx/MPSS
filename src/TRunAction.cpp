...
TRunAction::TRunAction(const KEI::TConfigFile& config) : G4UserRunAction(), mConfig(config) {
	...
	analysisManager->CreateNtupleDColumn("Initial_position_X");
	analysisManager->CreateNtupleDColumn("Initial_position_Y");
	analysisManager->CreateNtupleDColumn("Initial_position_Z");
	analysisManager->CreateNtupleDColumn("Initial_momentum_PX");
	analysisManager->CreateNtupleDColumn("Initial_momentum_PY");
	analysisManager->CreateNtupleDColumn("Initial_momentum_PZ");
	analysisManager->CreateNtupleDColumn("Initial_kinetic_energy");
